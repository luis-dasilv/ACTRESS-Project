...
[R1_0,F1_0,E1_0,D1_0] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-1-0-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-1-0.csv OK')
[R1_10,F1_10,E1_10,D1_10]= RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-1-10-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-1-10.csv OK')
[R1_20,F1_20,E1_20,D1_20]= RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-1-20-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-1-20.csv OK')
[R1_30,F1_30,E1_30,D1_30]= RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-1-30-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-1-30.csv OK')
[R1_40,F1_40,E1_40,D1_40]= RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-1-40-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-1-40.csv OK')
[R2_0,F2_0,E2_0,D2_0] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-2-0-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-2-0.csv OK')
[R2_10,F2_10,E2_10,D2_10] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-2-10-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-2-10.csv OK')
[R2_20,F2_20,E2_20,D2_20] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-2-20-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-2-20.csv OK')
[R2_30,F2_30,E2_30,D2_30] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-2-30-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-2-30.csv OK')
[R2_40,F2_40,E2_40,D2_40] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-2-40-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-2-40.csv OK')
[R3_0,F3_0,E3_0,D3_0] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-3-0-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-3-0.csv OK')
[R3_10,F3_10,E3_10,D3_10] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-3-10-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-3-10.csv OK')
[R3_20,F3_20,E3_20,D3_20] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-3-20-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-3-20.csv OK')
[R3_30,F3_30,E3_30,D3_30] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-3-30-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
disp('LC-value-enc-3-30.csv OK')
[R3_40,F3_40,E3_40,D3_40] = RUN_LC_EN(readmatrix('data-gravel2/LC-value-enc-3-40-g2.csv'),'Gravel n\textsuperscript{o}2',1700);%reading matrix CSV
...
plotting_box_LC_EN(F1,angle,'Submerged Area : 2500mm\textsuperscript{2}','angle (\textsuperscript{o})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F2,angle,'Submerged Area : 3300mm\textsuperscript{2}','angle (\textsuperscript{o})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F3,angle,'Submerged Area : 4100mm\textsuperscript{2}','angle (\textsuperscript{o})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F0,area,'angle 0\textsuperscript{o}', 'Submerged Area (mm\textsuperscript{2})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F10,area,'angle 10\textsuperscript{o}', 'Submerged Area (mm\textsuperscript{2})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F20,area,'angle 20\textsuperscript{o}', 'Submerged Area (mm\textsuperscript{2})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F30,area,'angle 30\textsuperscript{o}', 'Submerged Area (mm\textsuperscript{2})','Gravel n\textsuperscript{o}2',1200)
plotting_box_LC_EN(F40,area,'angle 40\textsuperscript{o}', 'Submerged Area (mm\textsuperscript{2})','Gravel n\textsuperscript{o}2',1200)
...
view(3);
DATA_GRAVELN2=[angle angle angle; area_2500 area_3300 area_4100;mean(F1) mean(F2) mean(F3)]
save('DATA_GRAVELN2.mat','DATA_GRAVELN2')
title("Static Horizontal Anchoring Force on Gravel n\textsuperscript{o}2",Interpreter="latex",FontSize=18)
...
%%%% Clustering plot
In_out=[2 2 2 2 2;2 2 2 2 2;2 2 2 2 2];
...
view(3);
title("Distance between Static maximum and Dynamic Maximum on Gravel n\textsuperscript{o}2",Interpreter="latex",FontSize=16)
...
view(3)
title("Difference between Static maximum and Dynamic Maximum on Gravel n\textsuperscript{o}2",Interpreter="latex",FontSize=16)
