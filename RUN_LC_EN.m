function [Results_V2,ForceH_anchor_static,Ecart,Dis_Stat_Dyn] = RUN_LC_EN(data_pure,media,ymax)
%Run script for Load Cell and Encoder recordings
%Before loading CSV files, make sure no text is written inside, only numbers, prefill manually the added weight, angle, Modele and
%submerged area of the anchor in the CSV. [added-weight,angle,Modele,submerged Area]
...
for i=1:size(data,1)
    ...
    Mo_min= Mo(index_min);
    Mo_max=Mo_min+25/cali_fac; %25mm * calibration factor
